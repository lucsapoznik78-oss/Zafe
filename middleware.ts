...
export async function middleware(request: NextRequest) {
  ...
  const publicRoutes = ["/login", "/auth/callback", "/auth/confirm", "/historico", "/termos", "/api/cron", "/api/push", "/r/", "/sitemap.xml", "/robots.txt", "/google", "/liga", "/ranking", "/u/", "/concurso", "/economico", "/comunidade", "/copa", "/banido"];
