    ...
    return (
      <div className="space-y-1.5">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-green-400 text-black font-bold text-sm rounded-lg hover:bg-green-400/90 transition-colors"
        >
    ...
    <div className="bg-card border border-border rounded-xl p-4 space-y-3 max-w-sm">
      ...
      <div className="flex gap-2">
        <button
          onClick={join}
          disabled={loading}
          className="flex-1 py-2 bg-green-400 text-black font-bold text-sm rounded-lg hover:bg-green-400/90 disabled:opacity-50 transition-colors"
        >
