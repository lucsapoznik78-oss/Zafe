...
export const AVATARES: AvatarCatalogo[] = [
  // ============================================================== COMUNS (1)
  //
  // Os outros 11 comuns procedurais (Craque da Várzea, Chefe da Geral, Analista
  // de Bolão, Vovô Onda Curta, Maratonista, Luva Azul, Pipoca Quente, Saque
  // Certeiro, Manobra na Praça, Guardião do Gramado, Viciada em Escalação)
  // saíram em 22/08/26 — foram substituídos pela leva Hyper3D do kit .glb, que
  // rende muito melhor no card e no palco. O Entregador Relâmpago fica: é o
  // único procedural cujo visual (ciclista de capacete + óculos espelhados) não
  // tem par direto no kit atual, então segue no cast e aparece junto com os
  // novos hyper1-6 na seção Comum.
  {
