  ...
  return (
    <div className="py-8 max-w-2xl mx-auto space-y-8 text-sm text-muted-foreground">
      <div>
        ...
        <p className="text-xs">Última atualização: 28 de julho de 2026</p>
      </div>
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-white">8. Proteção de dados pessoais (LGPD)</h2>
        <p>
        ...
        <h3 className="text-sm font-semibold text-white pt-1">8.1. O que tratamos e com qual base legal</h3>
        <p>
        ...
        <h3 className="text-sm font-semibold text-white pt-1">8.2. Por quanto tempo guardamos</h3>
        <ul className="list-disc pl-5 space-y-2">
          <li>
        ...
        <h3 className="text-sm font-semibold text-white pt-1">8.3. Transferência internacional</h3>
        <p>
        ...
        <h3 className="text-sm font-semibold text-white pt-1">8.4. Seus direitos</h3>
        <p>
        ...
        <h3 className="text-sm font-semibold text-white pt-1">8.5. Incidentes de segurança</h3>
        <p>
      ...
      <section className="space-y-3">
        ...
        <p>
          Se você não concordar com a nova versão, pode encerrar sua conta antes da entrada em vigor,
          sem qualquer ônus, e terá devolvida a taxa de inscrição de edição que ainda não tenha
          começado. O uso da plataforma após a entrada em vigor da nova versão vale como aceitação
          dela apenas para o período posterior.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          Para dúvidas, suporte, defesa nos termos do §7 ou solicitações relacionadas à privacidade:{" "}
          <a href="mailto:contato@zafe.app.br" className="text-primary hover:underline">
            contato@zafe.app.br
          </a>
          .
