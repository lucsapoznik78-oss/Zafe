...
- ~~**H7 `[NEW]` — No 18+ age-gate at signup.**~~ ✅ FIXED 2026-06-07 — `LoginForm.tsx` cadastro agora exige data de nascimento, valida idade ≥ 18 antes do `signUp` (rejeita menores) e grava `birth_date` no metadata do usuário. (compliance, auth.)
